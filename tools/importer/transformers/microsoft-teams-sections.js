...
/**
 * Transformer: microsoft-teams section breaks + section metadata.
 * Template 'microsoft-teams' has 10 sections. Inserts <hr> breaks in
 * beforeTransform (while every section element still exists, before parsers
 * replace them) and Section Metadata blocks in afterTransform, anchored to a
 * marker <hr>. Selectors come from page-templates.json section.selector arrays
